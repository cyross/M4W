/**
 * @fileOverview Miyako4Web(Miyako for Web a.k.a M4W/m4w) Video Extension<br>
 * M4W用ビデオ対応拡張プラグイン
 ...
 * <tr><td>video</td><td>Videoオブジェクトの辞書オブジェクト</tr>
 * </table>
 * @example 実際のVideoを取得するときは以下の方法でアクセス可能<br>
 * 例1)<br>
 * function success(assets){<br>
 *    var video = assets.video.(id);<br>
 * }<br>
 * 例2)<br>
 * function success(assets){<br>
 *    var video = assets["video"]["id"];<br>
 ...
 * options.assets[].type には"video"と指定する
 * options.assets[].その他 にはVideoクラスコンストラクタの引数と同じものを指定
 *
